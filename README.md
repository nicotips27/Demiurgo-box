...
- **Texturas de terreno** — Texturas reales del pack Stunt Rally (CC0)
...
2. Acepta la música (opcional)
3. Selecciona "Nueva Partida"
4. Elige geografía y clima
5. ¡Crea tu mundo!
...
- **Texturas de terreno**: [Terrain textures pack from Stunt Rally 2.3](https://opengameart.org/content/terrain-textures-pack-from-stunt-rally-23) por CryHam (CC0)
...
Las texturas de terreno están bajo licencia **CC0** (dominio público).
